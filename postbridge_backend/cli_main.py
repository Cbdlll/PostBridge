...
from rpa_service.douyin.main import douyin_setup, DouYinVideo
from rpa_service.kuaishou.main import ks_setup, KSVideo
from rpa_service.shipinhao.main import weixin_setup, TencentVideo
from rpa_service.tk.main_chrome import tiktok_setup, TiktokVideo
